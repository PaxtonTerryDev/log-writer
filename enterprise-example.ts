...
class PaymentProcessor {
  ...
  private log = new Log('PaymentProcessor', undefined, undefined, ['audit', 'errors']);
...
class DebugService {
  ...
  private log = new Log('DebugService', undefined, undefined, ['debug', 'console']);
...
class ApiGateway {
  private log = new Log('ApiGateway');
