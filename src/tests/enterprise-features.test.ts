...
describe('Enterprise Logging Features', () => {
  ...
  describe('Named Transports Configuration', () => {
    ...
    const testConfigPath = join(testConfigDir, 'logrider.config.json');
  ...
  describe('Named Transport Usage in Log', () => {
    ...
    it('should use default transports from config', () => {
      const logger = new Log('TestService', undefined, testConfigPath);
    ...
    it('should support constructor-level default transport override', () => {
      const logger = new Log('DebugService', undefined, testConfigPath, ['debug', 'console']);
  ...
  describe('Production Use Cases', () => {
    it('should demonstrate government-grade separation of concerns', () => {
      ...
      const securityLogger = new Log('SecurityModule');
      ...
      const businessLogger = new Log('BusinessLogic');
      // businessLogger.info('Processing payment');
      
      // Debug info - goes to debug logs only  
      const devLogger = new Log('DevModule');
